...
namespace Prog3
{
    ...
    public:
        ...
        Sequence(int sz, const int a[SZ]); // + 3) создание экземпляров класса с инициализацией размером и значениями элементов последовательности
        ...
        Sequence & add(Sequence ptr1, Sequence ptr2); // +- 6) объединение двух последовательностей в одну; в результате формируется новый вектор с сохранением исходных
